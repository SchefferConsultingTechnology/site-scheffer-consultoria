  ...
  pt: {
    ...
    form: {
      ...
      validation: {
        ...
        phoneInvalid: "Informe um telefone brasileiro válido, com DDD (10 ou 11 dígitos).",
  ...
  en: {
    ...
    form: {
      ...
      validation: {
        ...
        phoneInvalid:
          "Please enter a valid Brazilian phone number with area code (10 or 11 digits).",
  ...
  es: {
    ...
    form: {
      ...
      validation: {
        ...
        phoneInvalid:
          "Ingresa un número de teléfono brasileño válido, con código de área (10 u 11 dígitos).",
