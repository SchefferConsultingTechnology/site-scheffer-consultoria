        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <div className="relative overflow-hidden rounded-3xl border border-border bg-surface p-6 sm:p-10 lg:p-16">
            ...
            <div className="relative">
              <p className="text-xs uppercase tracking-[0.3em] text-accent">{t.page.eyebrow}</p>
              <h1 className="mt-3 max-w-2xl font-display text-4xl font-bold tracking-tight sm:text-5xl">
                {t.page.heading}
              </h1>
              <p className="mt-4 max-w-xl text-base text-muted-foreground">{t.page.paragraph}</p>
              <div className="mt-8">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                >
                  {t.page.scheduleButton} <ArrowRight className="h-4 w-4" />
                </button>
                <a
