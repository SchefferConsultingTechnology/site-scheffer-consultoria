    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/70 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <a
            href="#contato"
            className="inline-flex h-9 items-center gap-1.5 rounded-full bg-primary px-4 text-sm font-medium text-primary-foreground shadow-[0_0_30px_-8px_var(--color-primary)] transition hover:opacity-90"
          >
            Falar agora <ArrowRight className="h-3.5 w-3.5" />
          </a>
        </div>
      </header>
      ...
      <section id="top" className="relative overflow-hidden bg-hero">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 px-6 py-24 lg:grid-cols-[1.15fr_0.85fr] lg:py-32">
          <div>
            ...
            <h1 className="mt-6 font-display text-5xl font-bold leading-[1.02] tracking-tight sm:text-6xl lg:text-7xl">
              Soluções digitais que <span className="text-gradient">movem</span>{" "}
              negócios adiante.
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Da ideia ao lançamento: criamos aplicações web, apps mobile e
              estratégias de marketing digital que geram resultado real.
              Consultoria técnica com visão de negócio.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                href="#contato"
                className="inline-flex h-12 items-center gap-2 rounded-full bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-glow)] transition hover:translate-y-[-1px]"
              >
                Começar um projeto <ArrowRight className="h-4 w-4" />
              </a>
              <a
                href="#servicos"
                className="inline-flex h-12 items-center gap-2 rounded-full border border-border bg-surface/40 px-6 text-sm font-medium text-foreground backdrop-blur transition hover:bg-surface"
              >
                Ver serviços
              </a>
            </div>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="relative aspect-square w-full max-w-md rounded-[2rem] border border-border/80 bg-surface/60 p-10 backdrop-blur-xl">
              <div className="absolute inset-x-8 top-8 flex items-center justify-between text-[10px] uppercase tracking-[0.3em] text-muted-foreground">
                <span>Scheffer</span>
              ...
              <div className="flex h-full items-center justify-center">
                <img
                  ...
                  className="h-64 w-64 rounded-full object-cover shadow-[var(--shadow-elegant)] ring-1 ring-border"
                />
              </div>
              <div className="absolute inset-x-8 bottom-8 flex items-center justify-between text-[10px] uppercase tracking-[0.3em] text-muted-foreground">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-sm text-sm text-muted-foreground">
              Times enxutos, entregas rápidas, código próprio e estratégia
              baseada em dados. Cuidamos da execução técnica e do posicionamento
              da marca.
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground">
              A Scheffer Consultoria nasce com uma identidade renovada, mas
              carrega mais de uma década de experiência entregando projetos de
              tecnologia e marketing para empresas de diversos portes.
              Combinamos maturidade técnica com a agilidade de quem começa hoje.
            </p>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border bg-surface p-10 sm:p-16">
            ...
            <div className="relative">
              ...
              <p className="mt-4 max-w-xl text-base text-muted-foreground">
                Conte o que você tem em mente. Respondemos em até 24 horas com
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a
                  href="#"
                  className="inline-flex h-12 items-center gap-2 rounded-full bg-accent px-6 text-sm font-semibold text-accent-foreground transition hover:opacity-90"
                >
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 sm:flex-row">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-sm font-semibold">
              Scheffer Consultoria
            </span>
          </div>
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Scheffer Consultoria. Todos os direitos
            reservados.
          </p>
