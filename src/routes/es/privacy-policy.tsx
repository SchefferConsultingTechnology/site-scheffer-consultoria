...
export const Route = createFileRoute("/es/privacy-policy")({
  head: () => {
    const t = privacyPolicyContent.es;
    return {
      links: buildSeoLinks("privacyPolicy", "es"),
      meta: [
        { title: t.metaTitle },
  ...
  component: () => <PrivacyPolicyPage locale="es" />,
});
