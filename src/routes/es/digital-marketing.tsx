...
export const Route = createFileRoute("/es/digital-marketing")({
  head: () => {
    const title = service.metaTitle.es;
    const description = service.metaDescription.es;
    return {
      links: buildSeoLinks("digitalMarketing", "es"),
      meta: [
        { title },
  ...
  component: () => <ServicePage service={service} locale="es" page="digitalMarketing" />,
});
